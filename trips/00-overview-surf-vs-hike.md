...
> [!TIP]
> **If you want to surf →** you don't need a full camp. **[Ericeira / Lisbon, Portugal](./surf-portugal-ericeira.md)** has the most forgiving August waves — rent boards, surf yourselves, add 1–2 lessons, and base in Lisbon to fold the city in. **[San Sebastián, Spain](./surf-san-sebastian-independent.md)** is the standout if you want the *city to be the trip* (world-class food + a beginner beach 15 min away, surfed independently with a couple of lessons). **[Costa Rica](./surf-costa-rica-nosara.md)** is the warm-water, lowest-cost pick — book coached mornings since August swells favor intermediates. See the [independent (non-camp) surf research](../research/surf-independent-and-city-surf.md).
>
