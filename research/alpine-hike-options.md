...
status: provisional
sources:
  - external-sources/hike-tour-des-combins.md
  - external-sources/hike-berliner-hoehenweg.md
  - external-sources/hike-alta-via-1-dolomites.md
  - external-sources/logistics-flights-august.md
created: 2026-06-02
author: Miles Kaming-Thanassi
tags: [research, provisional, hiking]
---
...
```mermaid
flowchart LR
    A[Group: experienced + fit] --> B{How much exposure / glacier do you want?}
    B -->|Most rugged, alpine mountaineering feel| C[Berliner Hoehenweg → Innsbruck/Munich]
    B -->|Big scenery, no via ferrata, iconic finish| D[Alta Via 1 → Venice]
    B -->|Quiet, classic, fewer crowds| E[Tour des Combins → Geneva]
```
