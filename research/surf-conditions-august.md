...
```mermaid
flowchart TD
    A[Advancing beginners, August] --> B{What do you optimize?}
    B -->|Most reliable waves every day| C[Costa Rica — peak season]
    B -->|Gentlest, lowest-stress whitewater| D[Ericeira Foz / Tamarindo]
    B -->|City + food, accept variable surf| E[San Sebastian / Zarautz]
    C --> C1[Forgiving: Tamarindo / Nosara]
    C --> C2[Push your level: Santa Teresa]
```
