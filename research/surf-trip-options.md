...
status: provisional
sources:
  - external-sources/surf-where-to-surf-august.md
...
- [August surf destinations overview](../external-sources/surf-where-to-surf-august.md)
- [Costa Rica surf seasons](../external-sources/surf-costa-rica-seasons.md)
- [Ericeira surf camps](../external-sources/surf-ericeira-camps.md)
- [Flight pricing](../external-sources/logistics-flights-august.md)

## Findings

**The August constraint matters.** August is peak Northern-Hemisphere summer. The destinations that are simultaneously (a) good surf, (b) forgiving for improvers, and (c) reachable for a 1-week trip narrow to a short list. Long-haul tropics (Bali, Lombok, Sri Lanka) are excellent surf but burn 2 travel days each way — poor value for one week. ([overview](../external-sources/surf-where-to-surf-august.md))
...
> [!TIP]
> **Two finalists: Portugal (Ericeira) and Costa Rica (Nosara).** Portugal wins on *forgiving waves + coaching density + an easy world-class city finish (Lisbon)*. Costa Rica wins on *cost, warm water, and pura-vida vibe*, but August waves are punchier — best mitigated by booking coached/guided mornings and basing in versatile Nosara/Guiones.
...
- Lock dates → pull live August airfares; Costa Rica green-season fares can be soft.
