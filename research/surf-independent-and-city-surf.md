...
sources:
  ...
  - external-sources/surf-san-sebastian.md
...
```mermaid
flowchart LR
    A[Not a camp — DIY + 1-2 lessons] --> B{Priority?}
    B -->|City IS the trip, great food| C[San Sebastian / Zarautz, Spain]
    B -->|Gentlest waves + Lisbon nearby| D[Ericeira or Lisbon/Caparica, Portugal]
    B -->|Warm water + lowest cost| E[Nosara / Santa Teresa, Costa Rica]
```
